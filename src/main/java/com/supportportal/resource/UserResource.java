...
import com.supportportal.SupportportalApplication;
...
import com.supportportal.utility.CaptchaUtil;
...
public class UserResource extends ExceptionHandling {
    ...
    static Logger logger4  = LogManager.getLogger(UserResource.class);
    ...
    public ResponseEntity<User> login(@RequestBody User user) {
    	...
    	logger4.info("request came to user controller");
    	logger4.info("requested use is "+user.getUsername());
		
        authenticate(user.getUsername(), user.getPassword());
    	logger4.info("after authentication");
